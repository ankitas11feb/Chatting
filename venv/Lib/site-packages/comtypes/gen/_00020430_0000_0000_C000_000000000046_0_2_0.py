...
__all__ = [ 'OLE_YPOS_HIMETRIC', 'IPictureDisp', 'OLE_YPOS_PIXELS',
           'Picture', 'OLE_ENABLEDEFAULTBOOL', 'IFontEventsDisp',
           'Default', 'OLE_TRISTATE', 'OLE_CANCELBOOL', 'IFontDisp',
           'Checked', 'Gray', 'OLE_XPOS_PIXELS', 'Monochrome',
           'OLE_XSIZE_CONTAINER', 'OLE_YPOS_CONTAINER', 'OLE_COLOR',
           'FONTUNDERSCORE', 'StdFont', 'StdPicture', 'Color',
           'OLE_XSIZE_HIMETRIC', 'FontEvents', 'FONTSIZE',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_HIMETRIC', 'VgaColor',
           'IFont', 'IPicture', 'OLE_HANDLE', 'OLE_XPOS_CONTAINER',
           'FONTBOLD', 'FONTITALIC', 'OLE_XSIZE_PIXELS',
           'OLE_YSIZE_PIXELS', 'OLE_YSIZE_HIMETRIC', 'Unchecked',
           'FONTNAME', 'FONTSTRIKETHROUGH', 'LoadPictureConstants',
